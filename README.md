...
建筑里住着 **100 位古今中外历史人物**：从秦始皇、汉武帝、李白、诸葛亮，到凯撒、拿破仑、爱因斯坦、马克思……人物馆全屏环形 3D 选人，每位配有风格化开场短片（水墨/油画/版画/壁画等艺术演绎，9:16 竖版 15 秒）；**全部 100 位名人**拥有独立人设、符合身份的声音，能和你对话、辩论、同台表演。你也可以**上传一张照片，生成属于自己的 3D 人物**（Tripo 不可达时自动降级为占位模特，不影响带入场景）。

不止于「玩」，你还能当**造物主**：在「场景工作室」里用一句话描述想要的世界，AI 自动生成地形、植被、建筑与道具，再把名人或你自己创造的角色作为 AI NPC 布置进去、配上玩法，保存后即可第三人称进入——你创造的世界，也能分享给大家。

## ✨ 核心亮点

- ⚖️ **AI 趣味法庭 · 出牌决定胜负**：3轮庭审，玩家手持4张预制牌（攻击论点/出示证据/嘲讽对方/要求记录），每轮2点弹药，命中争议点天平+8，判决由天平决定而非AI自由心证；判决书含高光时刻回放。
- 🎭 **六座可进入的 3D 场景 · 全部有真实核心循环**：趣味法庭（出牌+天平）、脱口秀开放麦（三维评分+callback回扣）、狼人杀（90s自由发言+动作标签+幽灵观战+复盘）、酒吧辩论（角度克制三角+双维度评分）、健身房（90秒三关电路：反应/节奏/力量）、图书馆（知识擂台赛：8题抢答+AI名人对手+combo加成），每一座都能真正「玩」而非看AI聊天。
- 🎬 **百位历史人物开场短片+法庭视频联动**：100位古今中外名人每人一支风格化视频，人物馆选人时播放；法庭中名人发言时同步显示视频+TTS语音，气质音色联动。
- 👥 **100 位名人深度可互动**：全部拥有独立人格（persona）＋符合人设的语音，可对话、组队，担任你的教练、评委、对手或队友。
...
## 🔥 Round 2 玩法重构（2026-09）

针对"做出来的游戏不好玩"的核心痛点，全部6个场景完成玩法重构：

| 场景 | 重构前 | 重构后 |
|---|---|---|
| 趣味法庭 | 玩家打字不影响结果，AI自由心证 | 4张预制牌+2点弹药+天平结算，3轮决胜，判决由天平决定 |
| 脱口秀 | 单值黑盒评分，3段独立 | 三维度评分（笑点/节奏/共鸣）+callback回扣+话题选择+60s限时 |
| 狼人杀 | 依次发言20s，出局干等10分钟 | 90s自由发言窗口+动作标签+幽灵观战+MAX_DAYS=4+复盘页 |
| 酒吧辩论 | AI固定+2反击，评分黑盒 | 数据/情感/逻辑三角克制+AI倾向每回合切换+双维度评分 |
| 健身房 | setInterval自动tick，玩家零输入 | 90秒三关电路：反应关+节奏关+力量关，名人教练异步点评 |
