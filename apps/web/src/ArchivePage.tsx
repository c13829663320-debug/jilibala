...
import { Archive, ArrowLeft, ChevronRight, Clock3, Gavel, RotateCcw, Trash2 } from 'lucide-react'
...
export default function ArchivePage({ archives, loading, error, onBack, onCourt, onRefresh, onOpenCase, onDelete, onClear }: ArchivePageProps) {
  ...
  return <main className="platform-shell archive-page">
    <header className="archive-topbar">
      <button type="button" className="archive-back-button" onClick={onBack} aria-label="返回上一页"><ArrowLeft size={15} /> 返回</button>
    </header>
    ...
    <footer className="platform-footer"><span>© 2025 BALA BALA</span></footer>
  </main>
}
